...
<body>
    <center>
        <input type="tel" id="pesan1" placeholder="NOMOR TUJUAN :  "><H10>contoh : 087748842242</H10>
        <input type="text" id="pesan2" placeholder="NAMA PAKET  :  "><H10>contoh : Super Mini</H10>
